...
export function validateIconSize(variant: String, iconSize: Rect): ZetaIconError {
  if (iconSize.width !== 24 || iconSize.height !== 24) {
    return new ZetaIconError(`${variant} icon size must be 24x24`, ErrorSeverity.high, "SizeError");
  }
